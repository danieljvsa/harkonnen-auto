...
export function AppointmentPreventiveMaintenance(){
    const navigation = useNavigation()
    const [isFullReview, setFullReview] = useState(false)
    const [isExtraReview, setExtraReview] = useState(false)
    const [obs, setObs] = useState('')
    const [address, setAddress] = useState('')
    const [isServiceCollection, setServiceCollection] = useState(false)
    const [isOil, setOil] = useState(false)
    const [isDamper, setDamper] = useState(false)
    const [isBattery, setBattery] = useState(false)
    const [isAirConditioning, setAirConditioning] = useState(false)
    const [isTires, setTires] = useState(false)
    const [isBrakes, setBrakes] = useState(false)
