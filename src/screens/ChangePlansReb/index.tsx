...
export function ChangePlansReb(){
    ...
    const {updateServicesChargesReb} = useContext(AuthContext)
                        ...
                        <ScrollView style={styles.list} >
                            <View style={styles.changes}>
                                <View style={styles.inputG} >
                                    ...
                                    <TextInput style={styles.input} placeholder="ex: 29.00" value={assistanceRequest} onChangeText={(text) => setAssistanceRequest(text)} />
                                </View>
                                <View style={styles.inputG} >
                                    <Text style={styles.inputTitle} >Serviços de Pick-up</Text>
                                    <TextInput style={styles.input} placeholder="ex: 25.00" value={pickup} onChangeText={(text) => setPickup(text)} />
                                </View>
                                <View style={styles.inputG} >
                                    <Text style={styles.inputTitle} >Auxílio Mecânico Móvel</Text>
                                    <TextInput style={styles.input} placeholder="ex: 27.00" value={mechanicalAssistance} onChangeText={(text) => setMechanicalAssistance(text)} />
                                </View>
                            </View>
                        </ScrollView>
