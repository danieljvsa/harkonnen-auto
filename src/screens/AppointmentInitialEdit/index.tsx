...
export function AppointmentInitialEdit({route}: any){
    ...
    const handleCloseButton = () => {
      ...
      const handleFinishClick = async () => {
        ...
        if(service === "breakMaintenance" && commitment){
            navigation.navigate('AppointmentBreakMaintenanceEdit' as never, {appointment: appointment, commitment: commitment} as never)
        } else if(service === "preventiveMaintenance" && commitment) {
            navigation.navigate('AppointmentPreventiveMaintenanceEdit' as never, {appointment: appointment, commitment: commitment} as never)
        }
